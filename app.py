...
def scribe_translator(user_input):
        ...
        with open("rules.txt", "r", encoding="utf-8") as f:
            for line in f:
                if "=" in line:
                    ...
                    # Extracts the archive word and cleans any notes
    ...
    for word in sorted(rules_dict.keys(), key=len, reverse=True):
        # This \b ensures we don't replace parts of words (e.g., 'the' inside 'there')
    ...
    STRICT COMMAND: 
    1. If a word looks like Modern English (e.g., 'cute', 'nice'), do NOT translate it unless it follows the 1860s phonetics.
    2. Use ONLY the Arabic mapping for the characters provided.
    ...
    for key in API_POOL:
        try:
            ...
            # Temperature 0 is the "Ultimate Accuracy" setting
            response = model.generate_content(
                f"TRANSCRIBE SOUNDS: {processed_text}",
